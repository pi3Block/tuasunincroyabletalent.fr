...
export function YouTubePlayer({
  ...
  useEffect(() => {
    if (isReady) {
      onControlsReadyRef.current?.({ play, pause, seekTo, mute, unMute, setVolume, getVolume, getCurrentTime })
    }
  }, [isReady, play, pause, seekTo, mute, unMute, setVolume, getVolume, getCurrentTime])
