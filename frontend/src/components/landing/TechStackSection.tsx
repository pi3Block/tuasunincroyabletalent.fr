/**
 * @fileoverview Technology stack section showcasing open source projects.
 * Features animated logos/cards with links to documentation.
 */
...
// Technology categories with items
...
// Floating tech bubble decoration
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Des technologies de pointe, libres et open source, pour une analyse vocale de qualité professionnelle.
          </p>
        </motion.div>
